  ...
  module BuiltinTypes
    module Model
      module SupportedProcessors
        class AttributesDeclaration < TypeDeclarations::ElementProcessor
          class << self
          ...
          def applicable?(value)
            value.is_a?(::Hash) &&
              value[:attributes_declaration].is_a?(::Hash) &&
              value[:attributes_declaration][:element_type_declarations].is_a?(::Hash)
          end
