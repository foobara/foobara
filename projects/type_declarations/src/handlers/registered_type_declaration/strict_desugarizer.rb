      ...
      class RegisteredTypeDeclaration < TypeDeclarationHandler
        ...
        class StrictDesugarizer < TypeDeclarations::Desugarizer
          def applicable?(strict_type_declaration)
            ...
            return false unless strict_type_declaration.hash? && strict_type_declaration.strict?

            raise "wtf" unless strict_type_declaration.absolutified?
          end

          def desugarize(strict_type_declaration)
            raise "wtf" unless strict_type_declaration.keys.all? { |k| k.is_a?(::Symbol) }
