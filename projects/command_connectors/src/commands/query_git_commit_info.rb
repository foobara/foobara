module Foobara
  module CommandConnectors
    module Commands
      ...
      #
      # git show -s --format='{"commit": "%H", "parent": "%P", "author": "%an <%ae>", "date": "%ad", "message": "%s"}' \
      ...
      class QueryGitCommitInfo < Foobara::Command
        ...
        class GitCommitInfoFileNotFoundError < Foobara::RuntimeError
          class << self
            def message
              format = '{"commit": "%H", "parent": "%P", "author": "%an <%ae>", "date": "%ad", "message": "%s"}'
        ...
        def load_git_commit_info
          ...
          self.parent = git_commit_info["parent"]
